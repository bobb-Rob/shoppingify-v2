...
ActiveRecord::Schema[7.0].define(version: 2023_03_12_231440) do
  ...
  create_table "default_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["default_category_id"], name: "index_default_items_on_default_category_id"
  end
  ...
  add_foreign_key "default_items", "default_categories"
